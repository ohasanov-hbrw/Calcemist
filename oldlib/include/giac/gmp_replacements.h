...
inline void alloc_mp_div(mpz_t *a, mpz_t *b, mpz_t *q, mpz_t *r,
                         mpz_t *alloc1 = nullptr, mpz_t *alloc2 = nullptr, 
                         mpz_t *alloc3 = nullptr, mpz_t *alloc4 = nullptr, 
                         mpz_t *alloc5 = nullptr) 
{
    // Direct LibTomMath mp_div call: mp_div(a, b, q, r)
    // If mpz_t is a typedef/wrapper for mp_int:
    mp_div(reinterpret_cast<mp_int*>(a), 
           reinterpret_cast<mp_int*>(b), 
           reinterpret_cast<mp_int*>(q), 
           reinterpret_cast<mp_int*>(r));
}