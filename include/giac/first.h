...
#if !defined(NO_TEMPLATE_MULTGCD) && (defined(RTOS_THREADX) || defined(BESTA_OS) || defined NSPIRE || defined KHICAS )
...
#ifndef alloc_mp_div
#define alloc_mp_div(a, b, q, r, a1, a2, a3, a4, a5) mpz_tdiv_qr(*(q), *(r), *(a), *(b))
#endif